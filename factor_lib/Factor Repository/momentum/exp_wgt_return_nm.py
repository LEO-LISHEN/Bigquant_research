...
FACTOR = {
    ...
    "formula": (
        ...
        "(ret_{t-i}*turn_{t-i}*decay_i)"
        "/sum_{i=0}^{L-1}(turn_{t-i}*decay_i)。"
    ),
    "input_schema": {
        "required": {
            "date": {
    ...
    "parameters": {
        ...
        "n_months": {
            "default": 6,
            "accepted_values": "正整数；华泰原始版本使用 3 或 6。",
            "effect": (
                "同时改变收益回看长度和指数衰减速度。"
            ),
            "changes_data_requirements": True,
    ...
    "usage_notes": [
        (
            "n_months=3 对应 exp_wgt_return_3m；"
            "n_months=6 对应 exp_wgt_return_6m。"
        ),
    ...
    "best_practice": {
        "instance_name": "exp_wgt_return_6m",
        "parameters": {
            "n_months": 6,
            "trading_days_per_month": 21,
        },
        "description": (
            "当前最佳实践实例为 6 个月指数衰减换手率加权收益因子。"
        ),
    },
    "pit_notes": [
        (
    ...
    "references": [
        (
            "华泰动量类因子研究："
            "exp_wgt_return_3m 与 exp_wgt_return_6m 旧 notebook。"
        ),
    ],
    "tags": [
        "momentum",
